...
DROP TABLE IF EXISTS public.json_content;

CREATE TABLE public.json_content (
    id      SERIAL PRIMARY KEY,
    payload JSONB NOT NULL
);

INSERT INTO public.json_content (payload)
VALUES (
$${
  "pets": [
    {
...
DROP TABLE IF EXISTS public.xml_content;
...
INSERT INTO public.xml_content (payload)
VALUES (
$$<?xml version="1.0"?>
<nutrition>
<daily-values>
...
DROP TABLE IF EXISTS public.pet_favfoods CASCADE;
CREATE TABLE public.pet_favfoods (
    id      SERIAL PRIMARY KEY,
...
DROP TABLE IF EXISTS public.nutrition_daily_values CASCADE;
